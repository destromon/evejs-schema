module.exports = (function() { 
	...
	public.render = function() {
		...
		this.controller
			...
			.once('temp-restore-error', function(error) {
				//setup an error response
